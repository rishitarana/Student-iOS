...
var Aashish = User(name: "Aashish", age: 23, height: 180, weight: 68, activityLevel: 7)

print("\(Aashish.name) is \(Aashish.age) years old. He is \(Aashish.height)cm tall and weighs \(Aashish.weight)kg. His activity level is \(Aashish.activityLevel).")
