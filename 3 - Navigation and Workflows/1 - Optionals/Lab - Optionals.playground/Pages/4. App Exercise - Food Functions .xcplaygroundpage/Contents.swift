...
func fitness(meal:String)->Meal?{
    return meals[meal]
}
if let breakfastLog = fitness(meal: "Breakfast"){
    print(breakfastLog)
}
else{
    print("No log found")
 ...
 */
func isSaved(meal:String)->Meal?{
    if let answer=meals[meal]{
        return answer
    }
    else{
        return nil
    }}
print(isSaved(meal: "Breakfastt"))
/*:
