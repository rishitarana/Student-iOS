...
//print("The value of foo is \(foo)")
//the scope of variable foo is inside the for loop and printing it outside will give an error
...
// variable x is available both inside and outside of for loop so it won't give an error
...
greeting(greeting: "Hi", name: "Abhay")
