...
//during integer division both the values were of integer type so the result was also an integer but here both value are explicitly declared a sdouble so there result will also be of double type based on declaration.
/*:
