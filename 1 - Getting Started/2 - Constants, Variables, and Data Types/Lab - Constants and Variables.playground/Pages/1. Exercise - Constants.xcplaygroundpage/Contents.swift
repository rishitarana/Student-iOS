...
print("it showed me an error as i declared friends as cosntant so its value can't be updated, so i changed it to var in line 10 and updated it to print it.")
